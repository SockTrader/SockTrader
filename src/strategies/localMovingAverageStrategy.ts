...
export default class LocalMovingAverageStrategy implements Strategy {
  ...
  constructor() {
    ...
    this._localExchange.addCandles(['BTC', 'USDT'], data.map((c: CoinbaseCandle) => this.mapCoinbaseCandle(c)));
